...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # refer image and semantic select and train/test mode
        parser.add_argument('--use_semantic', action='store_true', help='whether use semantic images as input')
        parser.add_argument('--use_coarse_match', action='store_true', help='whether use coarse match process for input')

        parser.add_argument('--select_list', type=str, default='0', help='the select list of refer image')
        parser.add_argument('--test_mode',action='store_true',help='change to test mode')
    ...
    def parse(self, save=False, if_print=True):
